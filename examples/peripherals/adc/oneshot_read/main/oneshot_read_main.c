...
void app_main(void)
{
    ...
    while (1) {
        ...
        if (do_calibration1_chan0) {
            ...
            ESP_LOGI(TAG, "ADC%d Channel[%d] Cali Voltage: %d mV // ADC%d Channel[%d] Cali Voltage: %d mV", ADC_UNIT_1 + 1, EXAMPLE_ADC1_CHAN0, voltage[0][0], ADC_UNIT_1 + 1, EXAMPLE_ADC1_CHAN1, voltage[0][1]);
        }
