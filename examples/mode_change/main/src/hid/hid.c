...
uint8_t keycodes[6][18] = {
    ...
    {HID_KEY_SHIFT_LEFT,    HID_KEY_Z,          HID_KEY_X,         HID_KEY_C,          HID_KEY_V,              HID_KEY_B,       HID_KEY_N,           HID_KEY_M,         HID_KEY_COMMA,  HID_KEY_PERIOD,     HID_KEY_SLASH,          HID_KEY_NONE,           HID_KEY_NONE,               HID_KEY_NONE,       HID_KEY_SHIFT_RIGHT,    HID_KEY_NONE,           HID_KEY_ARROW_UP,       HID_KEY_NONE},
    {HID_KEY_CONTROL_LEFT,  HID_KEY_GUI_LEFT,   HID_KEY_ALT_LEFT,  HID_KEY_NONE,       HID_KEY_NONE,           HID_KEY_SPACE,   HID_KEY_NONE,        HID_KEY_NONE,      HID_KEY_NONE,   HID_KEY_ALT_RIGHT,  HID_KEY_GUI_RIGHT,      HID_KEY_APPLICATION,    HID_KEY_NONE,               HID_KEY_NONE,       HID_KEY_CONTROL_RIGHT,  HID_KEY_ARROW_LEFT,     HID_KEY_ARROW_DOWN,     HID_KEY_ARROW_RIGHT}
};
